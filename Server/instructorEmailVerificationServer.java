...
public class instructorEmailVerificationServer{
    ...
    public static void startServer() {
        ...
        try (ServerSocket serverSocket = new ServerSocket(200)) {
    ...
    public static void insertVerificationCodeIntoDatabase(String email, String verificationCode) {
        try (Connection connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
            if (connection != null) {
                String insertQuery = "UPDATE instructorform SET verification_code = ?, expiration_time = NOW() + INTERVAL 1 HOUR WHERE email = ?";
    ...
    private static void updateVerificationStatusInDatabase(String email, boolean verificationSuccess) {
        try (Connection connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
            if (connection != null) {
                ...
                String updateVerificationStatusQuery = "UPDATE instructorform SET securityKey=?, is_verified = ? WHERE email = ?";
    ...
    public static String getActualVerificationCodeFromDatabase(String email) {
        ...
        try (Connection connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
             PreparedStatement preparedStatement = connection.prepareStatement("SELECT verification_code FROM instructorform WHERE email = ?")) {
